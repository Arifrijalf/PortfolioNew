...
const projects = [
  {
    ...
    imageSrcSet:
      "/assets/smart-baby-incubator_270318b2_480.webp 480w, /assets/smart-baby-incubator_270318b2.webp 512w",
    imageWidth: 512,
    imageHeight: 279,
    imageAlt:
      "Smart Baby Incubator prototype with an integrated PID control display",
    gallery: [
      {
        src: "/assets/smart-baby-incubator_270318b2.webp",
        alt: "Smart Baby Incubator prototype with PID control display",
        caption: "Prototype and integrated control display",
      },
      {
        src: "/assets/incubator-dashboard-preview_a884462a.webp",
        alt: "PID temperature control dashboard for the Smart Baby Incubator",
        caption: "PID dashboard preview with temperature and actuator controls",
      },
    ],
    description:
  ...
  },
  {
    ...
    imageSrcSet:
      "/assets/esp32-iot-dashboard-control-center_894421e8_480.webp 480w, /assets/esp32-iot-dashboard-control-center_894421e8_800.webp 800w, /assets/esp32-iot-dashboard-control-center_894421e8.webp 1200w",
    imageWidth: 1200,
    imageHeight: 695,
    imageAlt:
      "Steel Plant Control Center monitoring screen for the ESP32 IoT dashboard project",
    gallery: [
      {
        src: "/assets/esp32-iot-dashboard-control-center_894421e8.webp",
        alt: "Steel Plant Control Center monitoring screen",
        caption: "Live monitoring and relay-control view",
      },
      {
        src: "/assets/esp32-iot-dashboard_777f1689.webp",
        alt: "ESP32 IoT dashboard shown on a tablet in a workspace",
        caption: "Dashboard interface in a connected hardware workspace",
      },
    ],
    description:
  ...
  },
  {
    ...
    imageSrcSet:
      "/assets/sensor-tool-esp32-pinout_4f764215_480.webp 480w, /assets/sensor-tool-esp32-pinout_4f764215_800.webp 800w, /assets/sensor-tool-esp32-pinout_4f764215.webp 1024w",
    imageWidth: 1024,
    imageHeight: 1024,
    imageAlt:
      "ESP32 development board pinout reference used by the sensor diagnostic tool",
    gallery: [
      {
        src: "/assets/sensor-tool-esp32-pinout_4f764215.webp",
        alt: "ESP32 development board pinout reference",
...
function NameMarquee() {
  const names = Array.from({ length: 6 }, (_, index) => (
    <span key={index}>ARIF RIJAL FADHILAH</span>
  ));

  return (
    <div
      className="name-marquee hero-fade-in hero-fade-in--delayed"
      aria-hidden="true"
    >
...
export default function Home() {
  ...
  const shiftLightbox = (direction: number) => {
    setLightbox(current => {
      ...
      const nextIndex =
        (current.index + direction + current.project.gallery.length) %
        current.project.gallery.length;
  ...
  const handleContactSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (now - lastSubmitTimestamp < SUBMIT_COOLDOWN_MS) {
      const waitTime = Math.ceil(
        (SUBMIT_COOLDOWN_MS - (now - lastSubmitTimestamp)) / 1000
      );
    ...
    const loadingToast = toast.loading("Sending message", {
      description: "Connecting to the contact form...",
    });
    ...
    <div className="site-shell">
      ...
      <main id="main-content" tabIndex={-1}>
        <section
          ...
          id="top"
          aria-label="Portrait of Arif Rijal Fadilah"
        >
          <div className="opening-canvas">
            ...
            <a className="opening-link" href="#about">
              Read profile <ArrowDownRight size={15} />
            </a>
          </div>
        </section>
        ...
        <SmoothSection
          ref={aboutRef}
          state={aboutState}
          className="about-intro section-shell"
          id="about"
        ...
        >
          ...
          <div className="about-intro-copy">
            <p className="section-overline">
              Electronics Engineering · Padang State Polytechnic
            </p>
            <h1 id="about-title">
              Firmware, hardware,
              <br />
              and the work <em>between.</em>
            </h1>
            <p className="lede">
              I&apos;m Arif Rijal Fadilah, an Electronics Engineering student
              working across sensor interfaces, microcontroller firmware, and
              IoT telemetry—from the first reading at the bench to a dashboard
              someone can use.
            </p>
          </div>
          <dl className="about-facts">
            <div>
              <dt>Studying</dt>
              <dd>Electronics Engineering, 2024—present</dd>
            </div>
            <div>
              <dt>Working with</dt>
              <dd>
                Embedded systems, connected devices, and technical documentation
              </dd>
            </div>
            <div>
              <dt>Based in</dt>
              <dd>Padang, Indonesia</dd>
            </div>
          </dl>
        </SmoothSection>
        ...
        >
          <div className="section-heading">
            ...
            <p className="section-intro">
              These are projects where the useful work happens in the connection
              between hardware, software, measurement, and iteration.
            </p>
          </div>
          ...
          <div className="project-filter-bar">
            ...
            <div
              ...
              role="group"
              aria-label="Filter projects by technology or category"
            >
              ...
              return (
                ...
                >
                  <div
                    ...
                    aria-label={`${project.title} project evidence`}
                  >
                    <button
                    ...
                    >
                      ...
                      />
                      <span className="image-hover-description">
                        {project.description}
                      </span>
                      <span className="image-hover-cue">
                        <Maximize2 size={15} /> View gallery
                      </span>
                    </button>
                    <a
                      className="image-hover-detail"
                      href={project.repo}
                      target="_blank"
                      rel="noreferrer"
                    >
        ...
        <SmoothSection
          ref={practiceRef}
          state={practiceState}
          className="practice-section section-shell"
          id="practice"
        ...
        >
          <div className="section-heading">
            ...
            <p className="section-intro">
              Comfortable moving between a datasheet, a bench test, a firmware
              loop, and the interface that makes the data useful.
            </p>
          </div>
        ...
        >
          ...
          <div className="experience-main">
            ...
            <p className="experience-lede">
              The technical details matter because they make the next iteration
              clearer. I try to leave a system, test, and explanation that
              someone else can pick up.
            </p>
          </div>
          <ol className="timeline">
            {timeline.map(([date, role, place]) => (
              <li key={role}>
                <time>{date}</time>
                <strong>{role}</strong>
                <span>{place}</span>
        ...
        >
          <div className="contact-heading">
            <p className="section-overline">
              For projects, ideas, and practical questions
            </p>
            <h2 id="contact-title">
              Got a project
              <br />
            ...
            <a
              ...
              href="mailto:arifrijalfadhilah@gmail.com"
            >
              Drop me a line <ArrowUpRight size={19} />
            </a>
          </div>
          <div className="contact-grid">
            <div>
              <span>Email</span>
              <a href="mailto:arifrijalfadhilah@gmail.com">
            ...
            <div>
              <span>WhatsApp</span>
              <a
                href="https://wa.me/6289519777498"
                target="_blank"
                rel="noreferrer"
              >
                +62 895-1977-7498 <ArrowUpRight size={13} />
              </a>
            </div>
            <div>
              <span>GitHub</span>
              <a
                href="https://github.com/arifrijalf"
                target="_blank"
                rel="noreferrer"
              >
                github.com/arifrijalf <ArrowUpRight size={13} />
              </a>
            </div>
            <div>
              <span>Instagram</span>
              <a
                href="https://instagram.com/aarifrijal_"
                target="_blank"
                rel="noreferrer"
              >
                @aarifrijal_ <ArrowUpRight size={13} />
              </a>
            </div>
            <div>
              <span>LinkedIn</span>
              <a
                href="https://linkedin.com/in/arif-rijal-fadhilah"
                target="_blank"
                rel="noreferrer"
              >
                arif-rijal-fadhilah <ArrowUpRight size={13} />
              </a>
            </div>
          </div>
          <div className="contact-form-shell">
            <div className="contact-form-intro">
              ...
              <p>Shoot me a quick message here. I'll get back to you soon.</p>
            </div>
            <form className="contact-form" onSubmit={handleContactSubmit}>
              ...
              <label className="contact-field">
                ...
                <span
                  id="message-count"
                  className={`message-count${remainingCharacters < 100 ? " is-near-limit" : ""}`}
                  aria-live="polite"
                >
